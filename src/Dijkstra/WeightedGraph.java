package DijkstraTest3;

public class WeightedGraph {

	private int[][] edges; 			// Adjacency matrix
	private Object[] labels; 		// Array de Object

	public WeightedGraph(int n) {	// Constructor de la clase
		edges = new int[n][n];
		labels = new Object[n];
	}
	...
	// Se agrega los datos en la matrix de adjacencia
